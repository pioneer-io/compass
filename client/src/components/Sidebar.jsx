    ...
    <div className="flex flex-col w-64">
      <div className="flex flex-col h-0 flex-1 bg-gray-700">
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          ...
          <nav className='mt-5 flex-1 px-2 space-y-1 bg-gray-700'>
            <a href="/flags" className={`${(isCurrentPage('/flags') || isCurrentPage('/')) ? 'bg-black' : 'bg-gray-700'} text-white group flex items-center px-2 py-2 text font-medium rounded-md`}>
            ...
            <a href="/logs" className={`${isCurrentPage('/logs') ? 'bg-black' : 'bg-gray-700'} text-white group flex items-center px-2 py-2 text font-medium rounded-md`}>
            ...
            <a href="/account" className={`${isCurrentPage('/account') ? 'bg-black' : 'bg-gray-700'} text-white hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text font-medium rounded-md`}>
