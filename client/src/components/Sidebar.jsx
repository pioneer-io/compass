      ...
      <div className="flex flex-col h-0 flex-1 bg-gray-800">
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          ...
          <nav className='mt-5 flex-1 px-2 space-y-1 bg-gray-800'>
            ...
            <a href="/account" className={`${isCurrentPage('/account') ? 'bg-gray-900' : 'bg-gray-800'} text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md`}>
