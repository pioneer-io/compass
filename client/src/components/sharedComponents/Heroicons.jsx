...
function strategyIcon() {
  return (
    <span className="h-8 w-8 rounded-full bg-blue-800 flex items-center justify-center">
...
function toggledOffIcon() {
  return (
    <span className="h-8 w-8 rounded-full bg-pioneerRed flex items-center justify-center">
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
function editedIcon() {
  return (
    <span className="h-8 w-8 rounded-full bg-pioneerGreen-700 flex items-center justify-center">
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
function genericIcon() {
  return (
    <span className="h-8 w-8 rounded-full bg-pioneerBlue-400 flex items-center justify-center">
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
